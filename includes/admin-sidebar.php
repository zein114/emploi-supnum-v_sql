...
<!-- ma9yrt chi la ndor nchrak -->
    ...
    <nav class="sidebar-nav">
        <a href="../admin/dashboard" class="sidebar-item <?= $current_page === 'dashboard' ? 'active' : '' ?>">
        ...
        <a href="../admin/users" class="sidebar-item <?= $current_page === 'users' ? 'active' : '' ?>">
        ...
        <a href="../admin/professors" class="sidebar-item <?= $current_page === 'professors' ? 'active' : '' ?>">
        ...
        <a href="../admin/timetables" class="sidebar-item <?= $current_page === 'timetables' ? 'active' : '' ?>">
        ...
        <a href="../admin/weekly_workload" class="sidebar-item <?= $current_page === 'weekly_workload' ? 'active' : '' ?>">
            <svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="../admin/settings" class="sidebar-item <?= $current_page === 'settings' ? 'active' : '' ?>">
            <svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
