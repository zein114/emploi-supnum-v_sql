...
<aside class="admin-sidebar collapsed" id="adminSidebar">
    ...
    <div class="sidebar-header">
        <button class="sidebar-toggle" onclick="toggleSidebar()">
            <svg class="sidebar-toggle-icon" viewBox="0 0 20 20" fill="currentColor" stroke="currentColor" stroke-width="0.5" xmlns="http://www.w3.org/2000/svg">
...
<!-- ma9yrt chi la ndor nchrak -->
    <!-- Navigation Menu -->
    <nav class="sidebar-nav">
        <a href="../admin/dashboard.php" class="sidebar-item <?= $current_page === 'dashboard' ? 'active' : '' ?>">
            <svg class="sidebar-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="../admin/users.php" class="sidebar-item <?= $current_page === 'users' ? 'active' : '' ?>">
        ...
        <a href="../admin/professors.php" class="sidebar-item <?= $current_page === 'professors' ? 'active' : '' ?>">
            <svg class="sidebar-icon" viewBox="0 0 31.979 31.979" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="../admin/timetables.php" class="sidebar-item <?= $current_page === 'timetables' ? 'active' : '' ?>">
        ...
        <a href="../admin/weekly_workload.php" class="sidebar-item <?= $current_page === 'weekly_workload' ? 'active' : '' ?>">
            <svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <a href="../admin/settings.php" class="sidebar-item <?= $current_page === 'settings' ? 'active' : '' ?>">
            <svg class="sidebar-icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
