...
<head>
    ...
    <title>Emploi du temps de l'université - Portail étudiant</title>
    <meta name="description" content="Consultez votre emploi du temps universitaire en sélectionnant votre année et votre groupe">
...
<body>
    ...
    <main class="student-main">
        <div class="container container-md">
            ...
            <!-- Timetable Display (Hidden) -->
            <div id="timetableContainer" style="margin-top: 7rem; display: none;">
                <div id="timetableContainer" style="display: block;">
