                ...
                <div class="grid grid-2 gap-2" style="margin-bottom: 2rem; align-items: start;">
                    ...
                    <div class="glass-card quick-actions-card" style="padding: 1.5rem; height: 100%;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr; gap: 1rem;">
                            <a href="users" class="btn btn-secondary" style="justify-content: flex-start; padding: 1rem; color: #4a67c8">
                            ...
                            <a href="professors" class="btn btn-secondary" style="justify-content: flex-start; padding: 1rem; color: #4a67c8">
                            ...
                            <a href="timetables" class="btn btn-secondary" style="justify-content: flex-start; padding: 1rem; color: #4a67c8">
                            ...
                            <a href="weekly_workload" class="btn btn-secondary" style="justify-content: flex-start; padding: 1rem; color: #4a67c8">
                                <svg style="width: 1.25rem; height: 1.25rem; margin-right: 0.75rem;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
